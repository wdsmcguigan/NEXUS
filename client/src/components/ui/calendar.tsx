  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-neutral-900 text-primary-foreground hover:bg-neutral-900 hover:text-primary-foreground focus:bg-neutral-900 focus:text-primary-foreground dark:bg-blue-900 dark:text-neutral-50 dark:hover:bg-blue-900 dark:hover:text-neutral-50 dark:focus:bg-blue-900 dark:focus:text-neutral-50",
        day_today: "bg-neutral-100 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
          "day-outside text-neutral-500 opacity-50 aria-selected:bg-neutral-100/50 aria-selected:text-neutral-500 aria-selected:opacity-30 dark:aria-selected:bg-neutral-800/50 dark:aria-selected:text-neutral-400",
